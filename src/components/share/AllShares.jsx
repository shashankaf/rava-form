...
const AllShares = () => {
  ...
  const handleCreate = () => {
    router.push(`/dashboard/shares/create`);
  };

  const handleClick = (shareId) => {
    router.push(`/dashboard/shares/read/${shareId}`);
  };

  const handleEdit = (shareId) => {
    router.push(`/dashboard/shares/edit/${shareId}`);
  };
