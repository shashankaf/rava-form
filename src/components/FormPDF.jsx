    ...
    return (
      <div  className={`${shasenem.className} p-4`}>
        ...
        <div className="flex flex-col items-center my-6">
          ...
          <h2  className={`${shasenem.className} text-xl font-bold`}>بەڕێوەبەرایەتی گشتی پەروەردەی سلێمانی</h2>
          <h2  className={`${shasenem.className} text-xl font-bold`}>بەڕێوەبەرایەتی گشتی پەروەردەی سلێمانی</h2>
          <h2  className={`${shasenem.className} text-xl font-bold`}>پەیمانگای راڤە</h2>
        </div>
        <div className="flex flex-row justify-between w-2/3 m-auto">
          <p className={`${goran.className}`}>بەروار - </p>
          <p className={`${goran.className}`}>ژمارە - </p>
        </div>
        <div>
          <h1  className={`${goran.className} font-black text-3xl text-center py-4`}>فۆرمی بەشداریکردنی پۆلی ١٢</h1>
        </div>
        <div>
